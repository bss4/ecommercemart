...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo WEBSITE_URL;?>app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="<?php echo WEBSITE_URL;?>app-assets/images/pages/login.png" alt="branding logo">
                                </div>
                                                ...
                                                <form action="{{route('login')}}" method="post">
                                                   @csrf
                                                    ...
                                                    <div class="input-group mb-3">
                                                       <span class="error help-inline required">{{ $errors->first('email') }}</span>
                                                     </div>
                                                     @endif
                                                    ...
                                                    @if ($errors->has('password'))
                                                     <div class="input-group mb-3">
                                                     <span class="error help-inline required">{{ $errors->first('password') }}</span>
                                                   </div>
                                                   @endif
                                                        ...
                                                        <div class="text-left">
                                                            <fieldset class="checkbox">
                                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                                    <input type="checkbox">
                                                                    <span class="vs-checkbox" name="remember">
