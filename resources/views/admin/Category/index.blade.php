...
<div class="content-wrapper">
  ...
  <div class="content-body">
    ...
    <section class="users-list-wrapper">
     <input type="hidden" class="mart_type" value="category">
      <!-- users filter start -->
        ...
        <div class="card">
          <div class="card-content">
            <div class="card-body">
                ...
                <div class="col-12">
                  <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                    <div class="dropdown sort-dropdown mb-1 mb-sm-0">
                      ...
                      <a class="sellers_add" href="{{route('Category.add')}}">Add</a>
                    </div>
              ...
              <div id="categoryGrid" class="aggrid ag-theme-material"></div>
            </div>
          </div>
        </div>
      </div>      
