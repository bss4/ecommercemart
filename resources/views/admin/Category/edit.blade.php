                        ...
                        <div class="card-content">
                            <div class="card-body">
                               <div class="card-header">
                                      <h6 class=" py-1 mb-0 font-medium-2">Edit Category</h6>
                                      <h2>
                                ...
                                <div class="seller_add_account">
                                    <div>
                                        <!-- users edit account form start -->
                                          {{ Form::model( $modeldata, ['route' => ['Category.update', $modeldata->id], 'method' => 'post', 'role' => 'form'] ) }}
                                            <div class="row">
                                                 <div class="col-12 col-sm-6">
                                                  <div class="form-group">
                                                      <div class="controls">
                                                          ...
                                                          @foreach($storetype as $storetype_val)
                                                          
                                                            <option value="{{ $storetype_val['id'] }}" <?php if($storetype_val['id']==$modeldata->store_type_id){echo "selected";}?>>{{ $storetype_val['name'] }}</option>
                                                          
                                                          @endforeach
                                                          @endif
                                                          </select>
                                                          <span class="error help-inline">
                                                            {{ $errors->first('storetype') }}
                                                          </span>
                                                      </div>
                                                  </div>
                                                </div>
