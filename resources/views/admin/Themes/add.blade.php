                        ...
                        <div class="card-content">
                            <div class="card-body">
                              <div class="card-header">
                                      <h6 class=" py-1 mb-0 font-medium-2">Add Store Themes</h6>
                                      <h2>
                                ...
                                <div class="seller_add_account">
                                    <div>
                                        ...
                                        {{ Form::open( array( 'route' => ['Themes.save'], 'role' => 'form' , 'enctype' => 'multipart/form-data') ) }}
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                  <div class="form-group">
                                                      <div class="controls">
                                                          <label>Theme Name </label>
                                                          <input type="text" name="name" class="form-control" placeholder="Theme Name">
                                                  ...
                                                  <div class="form-group">
                                                      <div class="controls">
                                                          ...
                                                          <input type="text" name="theme_folder_name" class="form-control" placeholder="Theme Folder Name" id="noSpacesField">
