                        ...
                        <div class="card-content">
                            <div class="card-body">
                              <div class="card-header">
                                      <h6 class=" py-1 mb-0 font-medium-2">Edit Plan</h6>
                                      <h2>
                                ...
                                <div class="seller_add_account">
                                    <div>
                                        ...
                                        {{ Form::model( $modeldata, ['route' => ['Plans.update', $modeldata->id], 'method' => 'post', 'role' => 'form'] ) }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                  <div class="form-group">
                                                      <div class="controls">
                                                          <label>Price</label>
                                                          <input type="text" name="price" class="form-control" placeholder="Price" value="{{isset($modeldata->price)?$modeldata->price:''}}">
                                                          <span class="error help-inline">
                                                            {{ $errors->first('price') }}
                                                          </span>
                                                      </div>
                                                 ...
                                                 <div class="col-12 col-sm-12">
                                                  ...
                                                  <label>Description</label>
                                                    <textarea id="plan-description-editor" name="description">{{isset($modeldata->description)?$modeldata->description:''}}</textarea>
                                                    <script>
