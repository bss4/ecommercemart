                            ...
                            <div class="card bg-analytics text-white">
                                <div class="card-content">
                                    <div class="card-body text-center">
                                        <img src="<?php echo WEBSITE_URL;?>app-assets/images/elements/decore-left.png" class="img-left" alt="
            card-img-left">
                                        <img src="<?php echo WEBSITE_URL;?>app-assets/images/elements/decore-right.png" class="img-right" alt="
            card-img-right">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <div>
                                        <ul>
                                            <li><span title="Total Order" class="apexcharts-legend-marker" rel="1" data:collapsed="false" style="background: rgb(0, 143, 251); color: rgb(0, 143, 251); height: 12px; width: 12px; left: 0px; top: 0px; border-width: 0px; border-color: rgb(255, 255, 255); border-radius: 12px;"></span> {{$total_order_amount->total_order}} </li>
                                            <li><span title="Total Order Price" class="apexcharts-legend-marker" rel="1" data:collapsed="false" style="background: rgb(134 123 242); color: rgb(0, 143, 251); height: 12px; width: 12px; left: 0px; top: 0px; border-width: 0px; border-color: rgb(255, 255, 255); border-radius: 12px;"></span> {{$total_order_amount->total_price}} </li>
                                        </ul>
                                    </div>
                                    </div> 
                                    <h2 class="text-bold-700 mt-1 mb-25">${{!empty($total_deliverd_orders) ? number_format($total_deliverd_orders,2) : ''}}</h2>
                                    ...
                                    <div class="card-body">
                                        <div class="row pb-50">
                                            <div class="col-12 d-flex justify-content-between flex-column order-lg-1 order-2 mt-lg-0 mt-2">
                                                <div class="row">
                                                <div class="col-6">
                                                    <h1 class="text-bold-700 mb-25">2.7K</h1>
                                                    <p class="text-bold-500 mb-75">PACKAGE TYPES</p>
                                                ...
                                                <div class="col-6" style="text-align: right;">
                                                     <div class="dropdown chart-dropdown package_list">
                                    ...
                                    <div class="card-body">
                                        <div class="row pb-50">
                                            <div class="col-12 d-flex justify-content-between flex-column order-lg-1 order-2 mt-lg-0 mt-2">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <h1 class="text-bold-700 mb-25">Store Types</h1>
                                                        <!-- <p class="text-bold-500 mb-75">Catelogue Shop</p> -->
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 d-flex justify-content-between flex-column text-right order-lg-2 order-1">
                                        ...
                                        <hr />
                                        <div class="row avg-sessions pt-50" id="avg_stores">
                                           <!--  <div class="col-6">
                                                <p class="mb-0">Grocery and Daily Needs</p>
                                                <div class="progress progress-bar-primary mt-25">
                                                    <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="50" aria-valuemax="100" style="width:90%"></div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <p class="mb-0">Users: 100K</p>
                                            ...
                                            <div class="col-6">
                                                <p class="mb-0">Fashion Store & Accessories</p>
                                                <div class="progress progress-bar-danger mt-25">
                                                    <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="70" aria-valuemax="100" style="width:70%"></div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between pb-0">
                                    ...
                                    <div class="dropdown chart-dropdown hide">
                                ...
                                <div class="card-content" >
                                    <div class="card-body">
                                        ...
                                        <div class="chart-info d-flex justify-content-between mb-1 hide">
                                        ...
                                        <div class="chart-info d-flex justify-content-between mb-75 hide">
                                            <div class="series-info d-flex align-items-center">
                                                    ...
                                                    <td class="p-1">
                                                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Vinnie Mostowy" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-5.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Elicia Rieske" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-7.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Julee Rossignol" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-10.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Darcey Nooner" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-8.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td class="p-1">
                                                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Trina Lynes" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-1.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Lilian Nenez" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-2.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Alberto Glotzbach" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-3.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td class="p-1">
                                                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Lai Lewandowski" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-6.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Elicia Rieske" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-7.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                            ...
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Jeffrey Gerondale" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo WEBSITE_URL;?>app-assets/images/portrait/small/avatar-s-9.jpg" alt="Avatar" height="30" width="30">
                                                            </li>
                                                        </ul>
                                                    </td>
