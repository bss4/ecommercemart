...
<div class="content-wrapper">
  ...
  <div class="content-body">
    ...
    <section class="users-list-wrapper">
      <input type="hidden" class="mart_type" value="allpayment">
        <input type="hidden" class="site_url" value="{{ route('Payments.json') }}">
      <!-- users filter start -->
        ...
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              ...
              <div id="paymentsGrid" class="aggrid ag-theme-material"></div>
            </div>
          </div>
        </div>
      </div>      
