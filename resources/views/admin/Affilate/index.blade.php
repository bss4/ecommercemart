...
<div class="content-wrapper">
  ...
  <div class="content-body">
    ...
    <section class="users-list-wrapper">
       <input type="hidden" class="mart_type" value="affilate" />
       <input type="hidden" id="affilate_ajax" value="{{route('Affilate.json')}}" />
       <input type="hidden" id="edit_affilate" value="{{route('Affilate.edit',':id')}}" />
       <input type="hidden" id="delete_affilate" value="{{route('Affilate.delete',':id')}}" />
       <input type="hidden" id="view_affilate_seller" value="{{route('Affilate.seller',':id')}}" />
      <!-- users filter start -->
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                    <div class="dropdown sort-dropdown mb-1 mb-sm-0">
                      ...
                      <a class="sellers_add" href="{{route('Affilate.add')}}">Add</a> 
                ...
                {{ Form::open( array( 'route' => ['Affilate.alldelete'], 'role' => 'form', 'method' => 'post') ) }}
                <button type="submit" class="btn btn-primary" >Delete All</button>
                <div id="affilateGrid" class="aggrid ag-theme-material"></div>
               {{ Form::close() }}
            </div>
          </div>
        </div>
