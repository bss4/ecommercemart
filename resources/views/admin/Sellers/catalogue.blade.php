...
<div class="content-wrapper">
  ...
  <div class="content-body">
    ...
    <section class="users-list-wrapper">
        <input type="hidden" class="mart_type" value="catalogue">
        <input type="hidden" class="site_url" value="{{ route('Sellers.cataloguejson',$Id)}}">
        ...
        <div class="card">
          <div class="card-content">
            <div class="card-body">
                ...
                <div class="col-12">
                  <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                    <div class="dropdown sort-dropdown mb-1 mb-sm-0">
                      <button class="btn btn-white filter-btn dropdown-toggle border text-dark" type="button" id="dropdownMenuButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">1 - 10 of 20</button>
                      ...
                      <a class="sellers_add" href="{{route('Sellers.catalogueadd',$Id)}}">Add</a>
                    </div>
              ...
              <div id="sellerCatalogueGrid" class="aggrid ag-theme-material"></div>
            </div>
          </div>
        </div>
      </div>      
