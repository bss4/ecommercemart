...
<div class="content-wrapper">
  ...
  <div class="content-body">
    ...
    <section class="users-list-wrapper">
      <input type="hidden" class="mart_type" value="order">
        <input type="hidden" class="site_url" value="{{ route('Sellers.orderjson', $Id) }}">
        ...
        <div class="card">
          <div class="card-content">
            ...
            <div class="card-body">
              ...
              <div id="sellerOrderGrid" class="aggrid ag-theme-material"></div>
            </div>
          </div>
        </div>
      </div>      
