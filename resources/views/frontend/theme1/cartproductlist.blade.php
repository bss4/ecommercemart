...
<div class="mini_cart_item.{{ $i}}. js_cart_item flex al_center pr oh">
    ...
    <a href="{{ url('/').'/'.$shopid.'/single-product-detail/'.$cart_val['id']; }}" class="mini_cart_img">
    ...
    <div class="mini_cart_info">
        <a href="{{ url('/').'/'.$shopid.'/single-product-detail/'.$cart_val['product']['id'] }}" class="mini_cart_title truncate">{{ $cart_val["product"]["name"] }}</a>
