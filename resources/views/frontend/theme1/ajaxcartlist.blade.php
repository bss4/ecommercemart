...
<div class="row">
     <div class="col-12 col-md-6 cart_actions tl_md tc order-md-2 order-2 mb__30">
        <form method="post" action="javascript:void(0);" >
            ...
            <div class="coupon-code-box">
                ...
                <input type="submit" id="apply_coupon_code" value="Apply Coupon">
            </div>
        </form>
    </div>
</div>
                        ...
                        <div class="row al_center">
                            ...
                            <div class="col-12 col-md-12 col-lg-5">
                                ...
                                <div class="page_cart_info flex al_center">
                                    ...
                                    <a href="{{url('/').'/'.$shopid.'/single-product-detail/'.$details['product']['id']}}">

                                        <img class="lazyload w__100 lz_op_ef" src="{{isset($details['productsvariations']['image'])?PRODUCT_URL.$details['productsvariations']['image']:PRODUCT_URL.$details['product']['image']}}" data-src="{{isset($details['productsvariations']['image'])?PRODUCT_URL.$details['productsvariations']['image']:PRODUCT_URL.$details['product']['image']}}" alt="">

                                    </a>

                                    <div class="mini_cart_body ml__15">

                                        <h5 class="mini_cart_title mg__0 mb__5"><a href="{{ url('/').'/'.$shopid.'/single-product-detail/'.$details['product']['id'] }}">{{isset($details['product']['name'])?$details['product']['name']:''}}</a></h5>
                        ...
                        <div class="col-12 tr_md tc order-md-4 order-4 col-md-12">
                            ...
                            <form method="post" action="javascript:void(0);">
                                ...
                                <div class="total row in_flex fl_between al_center cd fs__18 tu">
                                    ...
                                    <div class="col-auto"><strong>Coupon:</strong><span>{{$code}}</span></div>
                                    ...
                                    @if($offer_type=='fix')
                                        ...
                                        <div class="coupon_price">-₹{{$amount_off}}</div>
                                        <a href="#" class="remove_coupon">[Remove]</a>
                            ...
                            <div class="total row in_flex fl_between al_center cd fs__18 tu">
                                ...
                                <div class="col-auto tr js_cat_ttprice fs__20 fwm">
                                    <div class="coupon_price">₹{{isset($coupon_discount)?$coupon_discount:$total}}</div>
                                </div>
