...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/images/k_favicon_32x.png">
    ...
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/font-icon.min.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/jquery-ui.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/reset.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/defined.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/base.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/style.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/home-default.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/single-masonry-theme.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/single-product.css">
    <style type="text/css">
                        ...
                        <div class="row al_center css_h_se">
                                    ...
                                    <ul id="nt_menu_id" class="nt_menu in_flex wrap al_center">
                                            ...
                                            <div class="sub-menu">
                                                <div class="lazy_menu lazyload">
                                                    ...
                                                    @foreach(menu($shopid) as $cat_val)
                                                     ...
                                                     <div class="menu-item catalogue-menu" data-id="{{ $cat_val->id }}">
                                                        <a href="{{ url('/').'/'.$shopid. '/catalogs/' . $cat_val->id }}">{{ $cat_val->name }}</a></div>
                                        ...
                                        <li class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">
                                            ...
                                            <div class="sub-menu">
                                                ...
                                                <div class="menu-item">
                                                <a href="{{ route('frontend.myaccount',$shopid) }}" class="push_side">My Account</a>
                                                </div>
                                                <div class="menu-item">
                                                 <a href="{{ route('frontlogout',$shopid) }}" class="push_side">Logout</a></div>
                                                 <div class="menu-item">
                            ...
                            <div class="col-lg-auto col-md-4 col-3 tr col_group_btns">
                                <div class="nt_action in_flex al_center cart_des_1">  
                                     ...
                                     @if(!empty(Auth::user()->id))                              
                                    <a class="icon_like cb chp position-relative dn db_md js_link_wis" href="{{route('frontend.wishlist',$shopid)}}"><i class="iccl iccl-heart pr"><span class="op__0 ts_op pa tcount bgb br__50 cw tc wishlist_count">{{  count((array) session('wishlist')) }}</span></i>
                                    </a>
                                    @endif
                                    @if(Route::currentRouteName()!='frontend.checkout')
                                    <div class="icon_cart pr">

                                        <a class="push_side position-relative cb chp db" href="#" data-id="#nt_cart_canvas"><i class="iccl iccl-cart pr"><span class="op__0 ts_op pa tcount bgb br__50 cw tc cart_count">{{  count((array) session('cart')) }}</span></i></a>
                                    </div>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="menu_footer widget_footer">
                                    <ul class="menu">
                                        ...
                                        @foreach(menu($shopid) as $cat_val)
                                         ...
                                         <li class="menu-item">
                                            <a href="{{ url('/').'/'.$shopid. '/catalogs/' . $cat_val->id }}">{{ $cat_val->name }}</a></li>
        ...
        <div id="kalles-section-footer_bot" class="kalles-section footer__bot">
            <div class="footer__bot_wrap pt__20 pb__20">
                <div class="container pr tc">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">Copyright © 2021
                            <span class="cp">Make My Mart</span>, All rights reserved.</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mini_cart_wrap">
            <div class="mini_cart_content fixcl-scroll">
                <div class="fixcl-scroll-content"><p class="form-row">
                    ...
                    <p class="mb__10 mt__20">Lost password?
        ...
        <div id="kalles-section-mb_nav" class="kalles-section">
            <ul id="menu_mb_ul" class="nt_mb_menu">
               ...
               <li class="menu-item menu-item-btns menu-item-acount">
                    <a href="{{ route('frontlogout',$shopid) }}"><span class="iconbtns">Logout</span></a>
                </li>
                <li class="menu-item menu-item-btns menu-item-wishlist">
                    <a class="js_link_wis" href="{{route('frontend.wishlist',$shopid)}}"><span class="iconbtns">Wishlist</span></a>
                </li>

                <li class="menu-item menu-item-btns ">
                    <a class="js_link_wis" href="{{ route('frontend.myaccount',$shopid) }}"><span class="iconbtns">My Account</span></a>
                </li>
...
<script data-cfasync="false" src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/email-decode.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/jquery-3.5.1.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/jarallax.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/packery.pkgd.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/jquery.hoverIntent.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/magnific-popup.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/flickity.pkgd.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/lazysizes.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/js-cookie.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/jquery.countdown.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/photoswipe.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/photoswipe-ui-default.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/drift.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/isotope.pkgd.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/resize-sensor.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/theia-sticky-sidebar.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/js/interface.js"></script>
