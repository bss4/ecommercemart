...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/images/k_favicon_32x.png">
    ...
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/css/font-icon.min.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme1/assets/css/jquery-ui.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/css/reset.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/css/defined.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/css/base.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/css/style.css">
    <link rel="stylesheet" href="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/css/home-digital.css">
    <style type="text/css">
                                                ...
                                                <div class="lazy_menu lazyload">
                                                    @if(!empty(Auth::user()->id))
                                                        <div class="menu-item">
                                                         ...
                                                         <div class="menu-item">
                                                         <a href="{{ route('frontend.myaccount',$shopid) }}" class="push_side">My Account</a></div>
                                                         <div class="menu-item">
                                ...
                                <div class="nt_action in_flex al_center cart_des_1">
                                    ...
                                    <div class="icon_cart pr">
                                        ...
                                        <a class="push_side pr cb chp db" href="#" data-id="#nt_cart_canvas">
                                            <i class="las la-shopping-cart pr"><span class="op__0 ts_op pa tcount bgb br__50 cw tc cart_count">{{  count((array) session('cart')) }}</span></i>
                                        </a>
                                    </div>
                                    @endif
                                </div>
            ...
            <ul id="menu_mb_ul" class="nt_mb_menu">
                ...
                @if(!empty(Auth::user()->id))
                   ...
                   <li class="menu-item menu-item-btns menu-item-acount">
                    ...
                    <li class="menu-item menu-item-btns menu-item-acount">
                        <a href="{{ route('frontend.myaccount',$shopid) }}" class="push_side"><span class="iconbtns">My Account</span></a>
                    </li>
                   @else
                    <li class="menu-item menu-item-btns menu-item-acount">
...
<script data-cfasync="false" src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/email-decode.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/jquery-3.5.1.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/jarallax.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/packery.pkgd.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/jquery.hoverIntent.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/magnific-popup.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/flickity.pkgd.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/lazysizes.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/js-cookie.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/jquery.countdown.min.js"></script>
<script src="<?php echo WEBSITE_URL;?>frontassets/theme6/assets/js/interface.js"></script>
