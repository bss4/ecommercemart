                                ...
                                <div class="row wrap_filter">
                                    ...
                                    <div class="col-12 col-md-3 widget">
                                        ...
                                        <div class="loke_scroll">
                                            ...
                                            <ul class="nt_filter_block nt_filter_color css_ntbar" data-filter_condition="and">
                                                @if(!empty($CatalogueAttributes) && in_array('Colour',$CatalogueAttributes))
                                                @foreach($CatalogueAttributes as $product_attr_val)
                                                    @if(strtolower($product_attr_val['attr_name'])=="colour")
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="#" aria-label="Narrow selection to products matching tag color black" class="filter" data-value="{{ $value }}">
                                    ...
                                    @foreach($CatalogueAttributes as $product_attr_val)
                                        ...
                                        <div class="col-12 col-md-3 widget">
                                            ...
                                            <h5 class="widget-title">By {{ $product_attr_val['attr_name'] }}</h5>
                                            ...
                                            <div class="loke_scroll">
                                                ...
                                                <ul class="nt_filter_block nt_filter_styleck css_ntbar" data-filter_condition="and">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="#" aria-label="Narrow selection to products matching tag size s" class="filter" data-value="{{ $value }}">{{ $value }}</a>
                                        ...
                                        <div class="col-12 col-md-12 widget">
                                            ...
                                            <div class="loke_scroll">
                                                ...
                                                <ul class="nt_filter_block nt_filter_color css_ntbar">
                                                    ...
                                                    foreach ($prodcut_att_value as $value) {?>
                                                    <li>
                                                        <input type="checkbox" class="productDetail color" value="{{ $value }}">  
                                                        {{ $value }}
                                                    </li>
                                                    <?php }
                                                    ?>
