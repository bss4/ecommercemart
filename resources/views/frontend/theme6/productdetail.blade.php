                                        ...
                                        <div class="btn-atc atc-slide btn_des_1 btn_txt_3">
                                            ...
                                            <div id="callBackVariant_ppr">
                                                ...
                                                <div class="variations mb__40 style__circle size_medium style_color des_color_1">
                                                    ...
                                                    @if($cata_attr_val->attr_name == 'Colour')
                                                    <div class="swatch is-color kalles_swatch_js">
                                                        ...
                                                        <h4 class="swatch__title">Color:
                                                            ...
                                                            {
                                                                $currentcolorarr = explode(',',$cata_attr_val->attr_value);

                                                                echo $currentcolorarr[0];
                                                            }
                                                            ?></span>
                                                        ...
                                                        <ul class="swatches-select swatch__list_pr d-flex">
                                                            ...
                                                            @if($cata_attr_val->attr_value!='')
                                                            <?php
                                                            for($i=0;$i<count($currentcolorarr);$i++)
                                                            {?>

                                                            <li class="ttip_nt tooltip_top_right nt-swatch swatch_pr_item color-type" data-escape="{{$currentcolorarr[$i]}}">

                                                                <span class="tt_txt">{{$currentcolorarr[$i]}}</span><span class="swatch__value_pr pr bg_color_{{$currentcolorarr[$i]}} lazyload"></span>
                                                    ...
                                                    <div class="swatch is-label kalles_swatch_js">
                                                        ...
                                                        <ul class="swatches-select swatch__list_pr d-flex">
                                                            ...
                                                            <?php
                                                            for($i=0;$i<count($currentsizearr);$i++)
                                                            {?>

                                                            <li class="nt-swatch swatch_pr_item pr size-type" data-escape="{{$currentsizearr[$i]}}">
                                ...
                                <div class="product-inner pr">
                                    ...
                                    <div class="product-image pr oh lazyload">
                                        ...
                                        <div class="nt_add_w ts__03 pa ">
                                            ...
                                            <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right add_to_wishlist" onclick="return add_to_wishlist(this);" data-id="{{$product_val->id}}"><span class="tt_txt">Add to Wishlist</span><i class="facl facl-heart-o"></i></a>
