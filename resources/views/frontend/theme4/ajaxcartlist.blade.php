                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart-product-image">
                                            <a href="{{url('/').'/single-product-detail/'.$details['product_id']}}"><img src="{{ isset($details['product']['image'])?PRODUCT_URL.$details['product']['image']:''}}" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
                                            <h4><a href="{{url('/').'/single-product-detail/'.$details['product_id']}}">{{isset($details['product']['name'])?$details['product']['name']:''}}</a></h4>
                                            <span>₹{{ isset($details['price'])?$details['price']:'' }}</span>
                                        </td>
                                    ...
                                    <tr class="cart-coupon-row">
                                        ...
                                        <td>
                                            ...
                                            <button type="submit" class="btn theme-btn-2 btn-effect-2" id="updatecart">Update Cart</button>
