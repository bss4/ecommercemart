                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="ltn__tab-menu-list mb-50">
                                    ...
                                    <div class="nav">
                                        ...
                                        <a class="active show" data-toggle="tab" href="#liton_tab_1_1">Dashboard <i class="fa fa-home"></i></a>

                                        <a data-toggle="tab" href="#liton_tab_1_2">Orders <i class="fa fa-file-text"></i></a>

                                        <!-- <a data-toggle="tab" href="#liton_tab_1_4">address <i class="fas fa-map-marker-alt"></i></a> -->

                                        <a data-toggle="tab" href="#liton_tab_1_5">Account Details <i class="fa fa-user"></i></a>

                                        <a href="{{ route('frontlogout',$shopid) }}">Logout <i class="fa fa-sign-in"></i></a>
