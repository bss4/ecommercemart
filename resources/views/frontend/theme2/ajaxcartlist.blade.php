                                    ...
                                    <tr>
                                        ...
                                        <td class="cart-product-info">
                                            ...
                                            <h4><a href="{{url('/').'/'.$shopid.'/single-product-detail/'.$details['product_id']}}">{{isset($details['product']['name'])?$details['product']['name']:''}}</a></h4>
                                             <h4><a href="{{url('/').'/'.$shopid.'/single-product-detail/'.$details['product_id']}}">{{isset($details['product']['unit'])?$details['product']['unit']:''}}</a></h4>

                                        </td>

                                        <td class="cart-product-price">₹{{ isset($details['product']['discount_price'])?$details['product']['discount_price']:'' }}</td>
