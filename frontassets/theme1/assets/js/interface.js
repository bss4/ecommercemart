            ...
            if ( data.length ) {
                ...
                $.magnificPopup.open( {
                    ...
                    items        : {
                        ...
                        src  : '<div class="mfp-with-anim popup-quick-view sdads" id="content_quickview">' + data + '</div>',
            ...
            if ( data.length ) {
                ...
                $.magnificPopup.open( {
                    ...
                    items        : {
                        ...
                        src  : '<div class="mfp-with-anim pp_qs tester" id="content_quickview">' + data + '</div>', /* can be a HTML string, jQuery_T4NT object, or CSS selector*/
